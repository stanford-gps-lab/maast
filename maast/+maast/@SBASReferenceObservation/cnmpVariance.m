...
% Set Constants
maastConstants = sgt.maast.constants.MAASTConstants;
...
% Preallocate
obj.Sig2CNMP = NaN(length(elevationAngles), 1);

% Calculate CNMP
obj.Sig2CNMP(svInView) = (a1^2 + a2^2) * exp(polyval(cnmp_coef,elevationAngles(svInView))).^2;
end