...
%
%   maast.SBASReferenceStationGrid.createUserGrid(varargin) creates a grid of SBAS
...
%   ----- maast.SBAReferenceStationGrid.createUserGrid('NumUsers', numUsers,
...
obj = maast.SBASReferenceStationGrid.fromsgtUserGrid(sgtUserGrid);
end