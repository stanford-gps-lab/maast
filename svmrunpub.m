function svmrunpub(gpsudrefun, geoudrefun, givefun, usrcnmpfun,...
...
satdata=[];
satdata = init_satdata_pub(geodata, alm_param, satdata, tstart, sat_dnu_sbas);
...
while tcurr<=tend
    ...
    satdata = init_satdata_pub(geodata, alm_param, satdata, tcurr, sat_dnu_sbas);
