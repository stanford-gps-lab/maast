classdef ReceiverTESLA_AMAC32 < ReceiverTESLA
    methods
        ...
        function verify_hmac_block(obj, MT50, hashpoint, time)
            ...
            elseif hmac_count < 5
                % Recover lost HMACS
                hmacs = DataRecovery.recover_data_32(hmacs, [MT50.get_datarec(1), MT50.get_datarec(2)], flag);
            end
        ...
        function output = check_if_dummy_mt50(obj, message)
            ...
            dummy_mt50 = MT50_AMAC32(uint8(zeros(obj.hmac_size, 1)), ...
