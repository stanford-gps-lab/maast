classdef MT50_AMAC36 < MT50
    ...
    methods
        ...
        function obj = MT50_AMAC36(HMAC1, HMAC2, HMAC3, HMAC4, HMAC5, hashpoint, prn)
            hmacs = [HMAC1, HMAC2, HMAC3, HMAC4, HMAC5];
            datarec = DataRecovery.generate_data_recovery_fields_36(hmacs);

            obj.aMAC = CreateAMAC.aggregate(36, 0, hashpoint, prn, hmacs);
    ...
    methods (Static)
        ...
        function mt50 = decode(message, prn)
            ...
            mt50 = MT50_AMAC36(aMAC, aMAC, aMAC, aMAC, aMAC, hash_point, prn);
            mt50.aMAC = aMAC;
