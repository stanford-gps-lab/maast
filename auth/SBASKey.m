classdef SBASKey < handle
    ...
    methods
        ...
        function data = signing_data(obj)
            ...
            data(1:2) = logical(de2bi(obj.level));
            data(3:18) = reshape(logical(de2bi(obj.key_short_hash, 8)), [], 1);
            data(19:50) = logical(de2bi(obj.expiration_time, 32));
            data(51:66) = reshape(de2bi(obj.authenticating_key_short_hash, 8), [], 1);
            data(67:end) = reshape(logical(de2bi(obj.key, 8)), [], 1);
        end
