classdef MT50_5HMAC < MT50
        ...
        function hmac = get_hmac(obj, index)
            ...
            switch index
                ...
                case 5
                    hmac = obj.HMAC_5;
                otherwise
                    error('MT50_HMAC:invalidIndex', 'can not handle index outside of 1-5');
            end
        end
    ...
    methods (Static)
        ...
        function mt50 = decode(message, time, prn)
            ...
            if  mt ~= 50
                error('MT50_HMAC:BadMessageType', 'Cannot decode message type %i.', mt);
            end
