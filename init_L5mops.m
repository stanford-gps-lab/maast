...
global L5MOPS_MT31_PATIMEOUT L5MOPS_MT32_PATIMEOUT 
global L5MOPS_DFRE_PATIMEOUT L5MOPS_AUTHDFRE_PATIMEOUT
global L5MOPS_MT39_PATIMEOUT L5MOPS_MT40_PATIMEOUT 
...
% if authentication is not enabled, do not extend the DFREI timeout
if isempty(AUTHENTICATION_ENABLED) || ~AUTHENTICATION_ENABLED
    L5MOPS_AUTHDFRE_PATIMEOUT = 19;
else
    % otherwise extend the DFREI timeout
    L5MOPS_AUTHDFRE_PATIMEOUT = 19;
end
